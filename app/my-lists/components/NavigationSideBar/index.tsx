...
import { ListItemOnMediasSaved } from '@/app/ts/interfaces/firestoreDataInterface'
...
function NavigationSideBar({ isOnMobile, mediaFetched, params }: {
    isOnMobile: boolean,
    mediaFetched?: {
        name: string,
        status: string,
    ...
    return (
        <React.Fragment>
            ...
            <AnimatePresence
                ...
                mode='wait'
            >
                {((isOnMobile && isFiltersMenuOpen == true) || (!isOnMobile && !isFiltersMenuOpen)) && (
                    <motion.div
                        id={styles.backdrop}
