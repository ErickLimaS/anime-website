...
export default function HeadingInfo({ mediaInfo, searchParams, imdbMediaInfo, imdbEpisodes }: {
    mediaInfo: ApiMediaResults, searchParams: { lang?: string }, imdbMediaInfo?: ImdbMediaInfo, imdbEpisodes?: ImdbEpisode[]
}) {
    return (
