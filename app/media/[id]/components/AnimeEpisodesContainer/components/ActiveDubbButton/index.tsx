...
function DubbedCheckboxButton({ isDubActive, clickAction, styleRow }: { isDubActive: boolean, clickAction: () => void, styleRow?: boolean }) {
    ...
    return (
        <div id={styles.dub_input_container} className={styleRow ? `${styles.row}` : ""}>
