...
function CrunchyrollEpisode({ episodeInfo, mediaId, motionStyle, episodesWatchedInfo, episodeNumber }: ComponentTypes) {

    return (
        <motion.li className={styles.container} variants={motionStyle} initial="initial" animate="animate" exit="initial">
            <Link href={episodeInfo.url} className={styles.img_container} target='_blank'>
                <Image
